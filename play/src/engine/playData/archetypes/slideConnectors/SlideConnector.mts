...
export abstract class SlideConnector extends Archetype {
    ...
    initialize() {
        ...
        this.z = getZ(layer.note.connector, this.head.time, this.headData.lane)
    }
    ...
    renderConnector() {
        ...
        for (let i = 0; i < 10; i++) {
            ...
            if (this.useFallbackSprite) {
                ...
                this.sprites.active.draw(layout, this.z, a * activeA)
                this.sprites.normal.draw(layout, this.z, a * (1 - activeA))
            } else {
